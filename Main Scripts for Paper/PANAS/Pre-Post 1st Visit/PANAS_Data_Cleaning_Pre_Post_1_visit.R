...
setwd('/Users/danielfeldman/Desktop/Prop Paper/PANAS/')

D_raw <- read.csv('NAP_PANAS.csv', header=T)

# D_demo<- read.csv('DemographicsWhole.csv', header = T)
# 
# D_demo <- D_demo[!(D_demo$subject_id == 'PROP31'),]
# 
# age<- D_demo$age_at_consent
# sex<- D_demo$sex
...
##Just Pre and Post first 6 vists-- NO OPEN LABEL
